...
//       {/* Hero Section */}
//       <section className="relative bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 text-white py-32">
...
//           </h1>
//           <p className="text-xl md:text-2xl mb-8 animate__animated animate__fadeIn animate__delay-2s">
//             Connect with experienced healthcare professionals in seconds.
//           </p>
...
//             />
//             <button className="bg-blue-700 px-6 py-4 text-white font-semibold hover:bg-blue-800 transition-all ease-in-out">
//               Search
//             </button>
//           </div>
//         </div>
...
//       {/* Interactive Top Doctors */}
//       <section className="py-16 bg-gray-100">
//         <div className="container mx-auto px-6 text-center">
//           <h2 className="text-4xl font-extrabold mb-8">Top Doctors</h2>
...
//                 <Link to="/login" className="bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 transition duration-200">
//                   Book Appointment
//                 </Link>
//               </div>
//             ))}
...
//             Our platform allows you to find the best doctors, book appointments, and stay on top of your health without the hassle. Trusted by thousands of patients.
//           </p>
//         </div>
//       </section>
...
//           <h3 className="text-3xl font-semibold mb-4">Ready to book your appointment?</h3>
//           <div className="space-x-6">
//             <Link to="/signup" className="bg-white text-blue-700 px-6 py-3 font-semibold rounded-lg hover:bg-gray-100 transition duration-200">
//               Sign Up
//             </Link>
//             <Link to="/login" className="bg-transparent border-2 border-white px-6 py-3 font-semibold rounded-lg hover:bg-white hover:text-blue-700 transition duration-200">
//               Log In
//             </Link>
//           </div>
//         </div>
...
//             <Link to="/top-doctors" className="hover:text-white">Doctors</Link>
//             <Link to="/about" className="hover:text-white">About</Link>
//             <Link to="/contact" className="hover:text-white">Contact</Link>
//           </div>
//           <p className="text-sm">&copy; 2026 Doctor Booking Platform</p>
//         </div>
//       </footer>
//     </div>
//   );
...
// import { Stethoscope, CalendarCheck, ShieldCheck, ArrowRight } from "lucide-react";
// import toast from "react-hot-toast";

// export default function HomePage() {
//   const handleDemoClick = () => {
//     toast.success("Login to book your first appointment!");
//   };
...
//             Find verified doctors, check availability, and confirm appointments
//             instantly — all in one platform.
//           </p>

//           <div className="mt-10 flex flex-wrap gap-4">
//             <Link
//               to="/signup"
//               className="bg-white text-blue-600 px-7 py-3 rounded-xl font-semibold hover:scale-105 transition"
//             >
//               Get Started
//             </Link>
...
//               className="flex items-center gap-2 border border-white/40 px-7 py-3 rounded-xl hover:bg-white/10 transition"
//             >
...
//             text="Only trusted and verified healthcare professionals."
//           />
//           <Feature
//             icon={<CalendarCheck size={28} />}
//             title="Instant Booking"
//             text="Real-time availability with instant confirmation."
//           />
//           <Feature
//             icon={<ShieldCheck size={28} />}
//             title="Secure & Private"
//             text="Your medical data is encrypted and protected."
//           />
//         </motion.div>
//       </section>
...
//                 viewport={{ once: true }}
//                 className="p-6 rounded-2xl border bg-gradient-to-b from-slate-50 to-white hover:shadow-xl transition"
//               >
//                 <h3 className="text-xl font-semibold">{spec}</h3>
//                 <p className="text-slate-500 mt-2">
//                   Book experienced {spec.toLowerCase()} instantly.
//                 </p>

//                 <Link
//                   to="/login"
//                   className="inline-flex items-center gap-2 mt-5 text-blue-600 font-medium"
//                 >
...
//             Start Booking Smarter Healthcare
//           </h2>
//           <p className="mt-4 text-blue-100">
//             Join patients who save time every day.
//           </p>
