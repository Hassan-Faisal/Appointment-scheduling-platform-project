...
//                     <div className="mt-5">
//                       <div className="flex items-center justify-between mb-2">
//                         <p className="text-sm font-semibold text-gray-700">Slots</p>
...
//       <button
//         onClick={toggleChat}
//         className="fixed bottom-6 right-6 bg-blue-600 text-white p-4 rounded-full shadow-md hover:scale-105 transition-all"
//       >
//         💬
//       </button>

//       {/* Chatbot */}
//       <Chatbot isOpen={isChatOpen} closeChat={toggleChat} />
//     </PatientLayout>
//   );
// }
...
export default function BookAppointment() {
  ...
  const [bookingKey, setBookingKey] = useState(null); // `${doctorId}_${start}_${end}`
  const [isOnline, setIsOnline] = useState(false); // ✅ NEW
  const [isChatOpen, setIsChatOpen] = useState(false); // Set the default state of the chatbot to closed (false)
                  ...
                  >
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-500">
                          {doctor.consultation_fee || "General"}
                        </p>
                      </div>
                    </div>
